...
export function defaultSx() {
  return `z-10 h-auto w-auto flex gri flex-shrink-0 justify-center items-center  cursor-pointer hover:bg-opacity-40 flex flex-col justify-start duration-500 ease-in-out bg-opacity-20 rounded-sm hover:shadow-lg shadow-black`;
}
